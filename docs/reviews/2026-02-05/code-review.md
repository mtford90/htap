...
- [x] **3.2: Hardcoded version in HAR export** ✓
  ...
  **Fixed:** Now imports and uses `getHtapVersion()`.
...
- [ ] **7.6: Empty states don't guide users**
  ...
  **Fix:** Add "Configure HTTP_PROXY to start capturing. See 'htap help'."
...
- [x] 3.2 - Use getHtapVersion() in HAR export ✓

...
- [x] **3.2: Hardcoded version in HAR export** ✓
  ...
  **Fixed:** Now imports and uses `getHttapVersion()`.
...
- [ ] **7.6: Empty states don't guide users**
  ...
  **Fix:** Add "Configure HTTP_PROXY to start capturing. See 'httap help'."
...
- [x] 3.2 - Use getHttapVersion() in HAR export ✓

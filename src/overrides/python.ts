 ...
 * HTTP clients to use the htap proxy and trust the CA certificate.
 *
 * The script patches httplib2 to respect HTTP_PROXY env vars and
 * use the htap CA certificate. All patching is wrapped in try/except
...
export function generatePythonOverrideScript(caCertPath: string): string {
  ...
  return [
    "# Generated by htap — patches Python HTTP clients to use the proxy",
    "",
    "import os",
    "",
    "# Patch httplib2 to trust htap CA certificate and use proxy",
    "try:",
    "    import httplib2",
    "",
    "    # Override CA_CERTS to trust htap's CA",
